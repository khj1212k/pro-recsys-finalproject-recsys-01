...
def main() -> None:
    ...
    A("")
    A(
        "팀 보고값(팀 최종 Notion 보고서 - 103명/405건 스냅샷에서 한 시점에 한 번 측정했고, 팀 방식 추론 시점과 "
        "학습 구간을 포함할 수 있는 정답 창으로 계산돼 누출로 부풀려졌을 가능성이 크며, 그 스냅샷이 없어 검증할 수 없다): "
        "MRR 0.897, Precision@5 0.798, nDCG@5 0.801, Coverage@5 0.408 "
