...
- 노출 편향: 클릭은 노출된 기사에서만 생기므로 P2 정답은 Ekstra Bladet의 노출 정책에 묶여 있고, poolneg 모델의 gain 50%가
  `pop_clicks_6h`다. 서빙 성능의 진짜 값은 P1과 P2 사이 어딘가이며 탐색 슬롯·propensity 로그로 온라인에서 확인해야 한다.
